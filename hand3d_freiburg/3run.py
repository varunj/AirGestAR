...
if __name__ == '__main__':
	...
	for img_name in image_list:
		...
		fig.savefig('./data/vid3_result/' + '_'.join(fileName.split('_')[:-1]) + '_out_' + fileName.split('_')[-1] + '.png')

		dic_2d[img_name] = coord_hw
		dic_3d[img_name] = keypoint_coord3d_v
		pickle.dump(dic_2d, open( "./result_dics/dic_vid3_2d.pickle", "wb" ) )
		pickle.dump(dic_3d, open( "./result_dics/dic_vid3_3d.pickle", "wb" ) )
